 ...
 * limitations under the License.
 */
var an="firebase-heartbeat-store",on=null;function sn(){return on||(on=Lt("firebase-heartbeat-database",1,{upgrade:function(e,t){if(0===t)e.createObjectStore(an)}}).catch((function(e){throw Qt.create("idb-open",{originalErrorMessage:e.message})}))),on}function un(e){return cn.apply(this,arguments)}function cn(){return(cn=(0,u.default)((function(e){var t,n;return(0,c.__generator)(this,(function(r){switch(r.label){case 0:return r.trys.push([0,2,,3]),[4,sn()];case 1:return[2,r.sent().transaction(an).objectStore(an).get(dn(e))];case 2:return(t=r.sent())instanceof Ke?zt.warn(t.message):(n=Qt.create("idb-get",{originalErrorMessage:null==t?void 0:t.message}),zt.warn(n.message)),[3,3];case 3:return[2]}}))}))).apply(this,arguments)}function ln(e,t){return fn.apply(this,arguments)}function fn(){return(fn=(0,u.default)((function(e,t){var n,r,i,a;return(0,c.__generator)(this,(function(o){switch(o.label){case 0:return o.trys.push([0,3,,4]),[4,sn()];case 1:return n=o.sent(),r=n.transaction(an,"readwrite"),[4,r.objectStore(an).put(t,dn(e))];case 2:return o.sent(),[2,r.done];case 3:return(i=o.sent())instanceof Ke?zt.warn(i.message):(a=Qt.create("idb-set",{originalErrorMessage:null==i?void 0:i.message}),zt.warn(a.message)),[3,4];case 4:return[2]}}))}))).apply(this,arguments)}function dn(e){return"".concat(e.name,"!").concat(e.options.appId)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zn(e,t){Dn(e.emulator,"Emulator should always be set here");var n=e.emulator.url;return t?"".concat(n).concat(t.startsWith("/")?t.slice(1):t):n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function zr(e){var t,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[];switch(e){case"Browser":t=Cr(Fe());break;case"Worker":t="".concat(Cr(Fe()),"-").concat(e);break;default:t=e}var r=n.length?n.join(","):"FirebaseCore-web";return"".concat(t,"/","JsCore","/").concat(en,"/").concat(r)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Ao)),rn(So,Oo,"esm2017");tn({apiKey:"AIzaSyD_aK9Samiq36GmoUl35P_5NzpxQkwfvY8",authDomain:"filmoteka-75759.firebaseapp.com",projectId:"filmoteka-75759",storageBucket:"filmoteka-75759.appspot.com",messagingSenderId:"84456311588",appId:"1:84456311588:web:6fd62d962f70da880801b1",measurementId:"G-YF4EWZTT7X",databaseURL:"https://filmoteka-75759-default-rtdb.europe-west1.firebasedatabase.app/"});var Po,Do,Mo,Uo=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:nn(),t=Yt(e,"auth");if(t.isInitialized())return t.getImmediate();var n=xn(e,{popupRedirectResolver:wo,persistence:[ya,Xi,$i]}),r=We("authTokenSyncURL");if(r){var i=Lo(r);zi(n,i,(function(){return i(n.currentUser)})),Bi(n,(function(e){return i(e)}))}var a=ze("auth");return a&&Jr(n,"http://".concat(a)),n}(),xo=new Ii,jo=document.querySelector("#sign-in-google"),Fo=document.querySelector("#sign-in-form"),Ho=document.querySelector(".logIn-modal"),Vo=document.querySelector("#sign-out-btn"),Bo=document.querySelector("#logIn"),zo=document.querySelector("#form-modal-close"),qo=document.querySelector(".js-form-auth__type-switch"),Wo=document.querySelector(".js-form__submit"),Go=document.querySelector(".js-form-auth__title"),Ko="authorization";Po=function(e){e?(Fo.style.display="none",jo.style.display="none",Vo.classList.remove("is-hidden"),Bo.classList.add("is-hidden"),Ho.classList.add("is-hidden")):(Fo.style.display="block",jo.style.display="block",Vo.classList.add("is-hidden"),Bo.classList.remove("is-hidden"))},at(Uo).onAuthStateChanged(Po,Do,Mo);var Jo=function(){Ho.classList.add("is-hidden"),Bo.classList.remove("is-hidden")},Xo=function(t,n){Fi(Uo,t.value,n.value).then((function(t){var n=t.user;console.log("New user: "+n.email),e(W).Notify.success("New user account logged in")})).catch((function(t){var n=t.code,r=t.message;console.log({errorCode:n,errorMessage:r}),e(W).Notify.failure(r)}))},Yo=function(t,n){Vi(Uo,t.value,n.value).then((function(t){var n=t.user;console.log("user: "+n.email),e(W).Notify.success("You are log in")})).catch((function(t){var n=t.code,r=t.message;console.log({errorCode:n,errorMessage:r}),e(W).Notify.failure(r)}))},$o=function(){Da(Uo,xo).then((function(t){Ii.credentialFromResult(t).accessToken;var n=t.user;e(W).Notify.success("Hello ".concat(n.displayName)),console.log("user: "+n.email)})).catch((function(t){var n=t.code,r=t.message,i=t.customData.email,a=Ii.credentialFromError(t);console.log({errorCode:n,errorMessage:r,email:i,credential:a}),e(W).Notify.failure(r)}))},Qo=function(){var e=document.querySelector(".js-conditions");"authorization"===Ko?(Ko="registration",e.removeAttribute("hidden")):(Ko="authorization",e.setAttribute("hidden",""));var t="authorization"===Ko?"Registration":"Sign In",n="authorization"===Ko?"Sign In":"Register now",r="authorization"===Ko?"Sign In":"Registration";qo.textContent=t,Wo.textContent=n,Go.textContent=r,Fo.reset()},Zo=function(e){e.preventDefault();var t=e.target.elements,n=t.email,r=t.password;"registration"===Ko?(Xo(n,r),Qo()):"authorization"===Ko&&Yo(n,r)};Vo.addEventListener("click",(function(){qi(Uo).then((function(){Fo.reset()}))})),Bo.addEventListener("click",(function(){Ho.classList.remove("is-hidden"),Bo.classList.add("is-hidden"),zo.addEventListener("click",Jo),qo.addEventListener("click",Qo),Fo.addEventListener("submit",Zo),jo.addEventListener("click",$o)})),H()}();
//# sourceMappingURL=index.47dff341.js.map
